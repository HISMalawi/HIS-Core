...
export default defineComponent({
    ...
    setup() {
        ...
        const generate = async () => {
            ...
            try {
                reportData.value = (await report.getClinicReport('CLINIC CXCA SCRN', screeningMethod.value))                    
                    .slice(5)
        ...
        const configure = () => MultiStepPopupForm([
        {
            ...
            {
                      id: "screening_method",
                 helpText: "Disaggregate by Screening Methods",
                    ...
                    options: () => {
                        return [
                            ...
                            { label: "Speculum Exam",value: "Speculum Exam"},
                        ]
                    }
            }
        ],
        (f: any, c: any) => {
            ...
            screeningMethod.value = c.screening_method
