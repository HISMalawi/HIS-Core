<template>
    <ion-page>
        <v2Datatable :icon-url="logo" :subtitle="period" title="Cumulative NationalID Report" report-prefix="Clinic" :columns="columns"
...
const columns: Array<v2ColumnInterface[]> = [[
    ...
    drill({ label: 'Tx Curr', ref: "tx_curr"}),
...
const generate = () => wrapGeneration(async () => {
    reportData.value = []
    reportData.value = await report.getCumulativeNidReport()
})
